...
public class ExcluiMontado extends JPanel
{
    ...
    private void initComponents() {
        ...
        this.jPanel1.setBorder(BorderFactory.createTitledBorder(null, "Exclus\u00e3o de Montados", 2, 2, new Font("Andale Mono", 1, 18)));
        ...
        this.jTextFieldFonte.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt) {
                ExcluiMontado.this.jTextFieldFonteActionPerformed(evt);
            }
        });
        ...
        this.jButtonConsultar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                ExcluiMontado.this.jButtonConsultarActionPerformed(evt);
            }
        });
        ...
        this.jButtonLimpar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                ExcluiMontado.this.jButtonLimparActionPerformed(evt);
            }
        });
    ...
    private void jButtonExcluirActionPerformed(final ActionEvent evt) {
        if (this.jTextFieldNome.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Prencha com 'Nome' v\u00e1lidos .");
        }
        else {
            final Montado cli = new MontadoDAO().consulta(Integer.parseInt(this.jTextFieldId.getText()), this.jTextFieldNome.getText());
            if (cli == null) {
                JOptionPane.showMessageDialog(null, "N\u00e3o existe ou dados incorretos");
            }
            else {
                JOptionPane.showMessageDialog(null, "Tem certeza que quer excluir todos os dados de\n" + this.jTextFieldNome.getText() + " !");
                final Montado dao = new MontadoDAO().exclui(this.jTextFieldNome.getText());
            }
